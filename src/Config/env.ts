...
export const env = {
    ...
    JOB_MATERIAL_CONSUMPTION_EXEC_START_HOUR: get('JOB_MATERIAL_CONSUMPTION_EXEC_START_HOUR').required().asIntPositive(),
    JOB_MATERIAL_CONSUMPTION_EXEC_END_HOUR: get('JOB_MATERIAL_CONSUMPTION_EXEC_END_HOUR').required().asIntPositive(),
